...
class StrategicOracle:
    ...
    def scout_strategic_sectors(self):
        ...
        【核心任务】：发现 3 个当前正处于‘右侧交易窗口’（即趋势已确认、动能向上）且具备‘极高逻辑密度’（即战略深度绑定物理资产，如电站、矿产、核心供应链、核心专利技术）的战略板块。
        【任务增强】:在核心任务发现的每个板块中,请利用搜索能力锁定与每个板块相关的3个具体的中国A股股票标的(点寻找 10 元以下、基本面有实物资产、核心专利技术支撑、近期有主力异动的标的）。
